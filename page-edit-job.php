...
<div class="form-row">
    ...
    <input type="url" id="company_url" name="company_url" value="<?php echo esc_url(get_post_meta($job_id, 'company_url', true)); ?>">
</div>
    ...
    <input type="text" id="facility_zipcode" name="facility_zipcode" value="<?php echo esc_attr($facility_zipcode); ?>" placeholder="123-4567" required>
</div>
